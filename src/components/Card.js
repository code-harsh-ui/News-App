...
export default class Card extends Component {
  render() {
    ...
    // Here we get the props from 'NewsContainer.js' file 'publishedAt', 'author', 'source'
    ...
    return (
      <div className='my-3'>
        <div className="card" style={{ width: "20rem", height: "33rem" }}>
          <span class="position-absolute top-0 translate-middle badge rounded-pill bg-danger" style={{left: '60px'}}>
            {source}
          </span>
          ...
          <div className="card-body">
            ...
            {/* Using these props 'publishedAt' and 'author' in card to show author name and published times */}
